...
data class MeasurementConverter(
  ...
  override val icon: ConverterIcon = ConverterIcon.SwapHoriz,
...
data class TextConverter(
  ...
  override val name: String,
  override val category: Category,
  override val icon: ConverterIcon = ConverterIcon.TextFields,
  override val aliases: List<String> = emptyList(),
  val modes: List<Mode>,
...
data class StandaloneConverter(
  ...
  override val name: String,
  override val category: Category,
  override val icon: ConverterIcon = ConverterIcon.Build,
  override val aliases: List<String> = emptyList(),
...
data class CalculatorConverter(
  ...
  override val name: String,
  override val category: Category,
  override val icon: ConverterIcon = ConverterIcon.Calculate,
  override val aliases: List<String> = emptyList(),
