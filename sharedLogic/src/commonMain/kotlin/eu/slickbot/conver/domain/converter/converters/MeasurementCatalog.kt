...
fun temperatureConverter(): MeasurementConverter = MeasurementConverter(
  ...
  name = "Temperature",
  category = Category.Measurement,
  icon = ConverterIcon.DeviceThermostat,
...
fun powerConverter(): MeasurementConverter = MeasurementConverter(
  ...
  name = "Power",
  category = Category.Measurement,
  icon = ConverterIcon.ElectricBolt,
...
fun angleConverter(): MeasurementConverter = MeasurementConverter(
  ...
  name = "Angle",
  category = Category.Measurement,
  icon = ConverterIcon.RotateRight,
  aliases = listOf("degree", "radian", "gradian"),
  units = listOf(
    MeasureUnit.linear("rad", "Radian", "rad", 1.0),
    MeasureUnit.linear("deg", "Degree", "°", PI / 180.0),
    MeasureUnit.linear("grad", "Gradian", "grad", PI / 200.0),
    MeasureUnit.linear("arcmin", "Arcminute", "'", PI / (180.0 * 60.0)),
    MeasureUnit.linear("arcsec", "Arcsecond", "\"", PI / (180.0 * 3600.0)),
    MeasureUnit.linear("turn", "Turn", "turn", 2.0 * PI),
  ),
  defaultFromId = "deg",
  defaultToId = "rad",
)
...
fun dataRateConverter(): MeasurementConverter = MeasurementConverter(
  ...
  name = "Data rate",
  category = Category.Measurement,
  icon = ConverterIcon.NetworkCheck,
...
fun fuelEconomyConverter(): MeasurementConverter = MeasurementConverter(
  ...
  name = "Fuel economy",
  category = Category.Measurement,
  icon = ConverterIcon.LocalGasStation,
